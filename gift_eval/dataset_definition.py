...
MV_DATASETS = "jena_weather bizitobs_application bizitobs_service bizitobs_l2c ett1 ett2".split()
# currently excluding: 
# - bitbrains_fast_storage (too long)
# - bitbrains_rnd (too long)
...
ALL_MV_DATASETS = [ds for ds in ALL_DATASETS if any(mv_ds in ds for mv_ds in MV_DATASETS)]
