...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Submit mini-ft-lightning.py as an SBATCH job using submitit"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--wandb_tags", type=str, nargs="+", default=None, help="Tags for the W&B run"
    )
    parser.add_argument(
        "--run_name", type=str, default=None, help="Name for the W&B run"
    )
    parser.add_argument(
